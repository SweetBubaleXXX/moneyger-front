import { List, ListDivider, ListSubheader, Skeleton, Stack, Typography } from '@mui/joy';
import React from 'react';

import { useGetAccountQuery } from '../../api/apiSlice';
import { ChangePasswordSetting } from '../../components/settings/ChangePasswordSetting';
...
export const Settings = () => {
  ...
  return (
    <>
      <Stack maxWidth="sm" mx="auto" p={2} spacing={2}>
        <Typography level="title-lg" textAlign="center" noWrap>
          <Skeleton loading={account.isFetching}>{account.data?.username || 'Settings'}</Skeleton>
        </Typography>
        <List
          variant="soft"
          sx={{
